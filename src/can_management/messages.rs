...
impl Messages {
    ...
    pub fn from_can_message(id: u32, payload: &[u8]) -> Result<Self, CanError> {
        ...
        let res = match id {
            ...
            307 => Messages::PcuRf(PcuRf::try_from(payload)?),
...
impl Pcu {
    ...
    pub const PUMPL_SPEED_MIN: f32 = -1_f32;
    pub const PUMPL_SPEED_MAX: f32 = 100_f32;
    pub const PUMPR_SPEED_MIN: f32 = -1_f32;
    pub const PUMPR_SPEED_MAX: f32 = 100_f32;
    pub const FANBATTL_SPEED_MIN: f32 = -1_f32;
    pub const FANBATTL_SPEED_MAX: f32 = 100_f32;
    pub const FANBATTR_SPEED_MIN: f32 = -1_f32;
    pub const FANBATTR_SPEED_MAX: f32 = 100_f32;
    pub const FANRADL_SPEED_MIN: f32 = -1_f32;
    pub const FANRADL_SPEED_MAX: f32 = 100_f32;
    pub const FANRADR_SPEED_MIN: f32 = -1_f32;
    pub const FANRADR_SPEED_MAX: f32 = 100_f32;
    
    /// Construct new Pcu from values
    pub fn new(pump_enable: bool, pumpl_speed: f32, pumpr_speed: f32, fanbatt_enable: bool, fanbattl_speed: f32, fanbattr_speed: f32, fanrad_enable: bool, fanradl_speed: f32, fanradr_speed: f32) -> Result<Self, CanError> {
        let mut res = Self { raw: [0u8; 6] };
        res.set_pump_enable(pump_enable)?;
        res.set_pumpl_speed(pumpl_speed)?;
        res.set_pumpr_speed(pumpr_speed)?;
        res.set_fanbatt_enable(fanbatt_enable)?;
        res.set_fanbattl_speed(fanbattl_speed)?;
        res.set_fanbattr_speed(fanbattr_speed)?;
        res.set_fanrad_enable(fanrad_enable)?;
        res.set_fanradl_speed(fanradl_speed)?;
        res.set_fanradr_speed(fanradr_speed)?;
        Ok(res)
    }
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn pump_enable(&self) -> bool {
        self.pump_enable_raw()
    }
    
    /// Get raw value of pump_enable
    ///
    /// - Start bit: 0
    /// - Signal size: 1 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn pump_enable_raw(&self) -> bool {
        let signal = self.raw.view_bits::<Lsb0>()[0..1].load_le::<u8>();
        
        signal == 1
    }
    
    /// Set value of pump_enable
    #[inline(always)]
    pub fn set_pump_enable(&mut self, value: bool) -> Result<(), CanError> {
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn pumpl_speed(&self) -> f32 {
        self.pumpl_speed_raw()
    }
    
    /// Get raw value of pumpl_speed
    ///
    /// - Start bit: 1
    /// - Signal size: 7 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn pumpl_speed_raw(&self) -> f32 {
        let signal = self.raw.view_bits::<Lsb0>()[1..8].load_le::<u8>();
    ...
    /// Set value of pumpl_speed
    #[inline(always)]
    pub fn set_pumpl_speed(&mut self, value: f32) -> Result<(), CanError> {
        #[cfg(feature = "range_checked")]
        if value < -1_f32 || 100_f32 < value {
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn pumpr_speed(&self) -> f32 {
        self.pumpr_speed_raw()
    }
    
    /// Get raw value of pumpr_speed
    ///
    /// - Start bit: 8
    /// - Signal size: 7 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn pumpr_speed_raw(&self) -> f32 {
    ...
    /// Set value of pumpr_speed
    #[inline(always)]
    pub fn set_pumpr_speed(&mut self, value: f32) -> Result<(), CanError> {
        #[cfg(feature = "range_checked")]
        if value < -1_f32 || 100_f32 < value {
            return Err(CanError::ParameterOutOfRange { message_id: 304 });
        }
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn fanbatt_enable(&self) -> bool {
        self.fanbatt_enable_raw()
    }
    
    /// Get raw value of fanbatt_enable
    ///
    /// - Start bit: 16
    /// - Signal size: 1 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn fanbatt_enable_raw(&self) -> bool {
        let signal = self.raw.view_bits::<Lsb0>()[16..17].load_le::<u8>();
        
        signal == 1
    }
    
    /// Set value of fanbatt_enable
    #[inline(always)]
    pub fn set_fanbatt_enable(&mut self, value: bool) -> Result<(), CanError> {
        let value = value as u8;
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn fanbattl_speed(&self) -> f32 {
        self.fanbattl_speed_raw()
    }
    
    /// Get raw value of fanbattl_speed
    ///
    /// - Start bit: 17
    /// - Signal size: 7 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn fanbattl_speed_raw(&self) -> f32 {
    ...
    /// Set value of fanbattl_speed
    #[inline(always)]
    pub fn set_fanbattl_speed(&mut self, value: f32) -> Result<(), CanError> {
        #[cfg(feature = "range_checked")]
        if value < -1_f32 || 100_f32 < value {
            return Err(CanError::ParameterOutOfRange { message_id: 304 });
        }
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn fanbattr_speed(&self) -> f32 {
        self.fanbattr_speed_raw()
    }
    
    /// Get raw value of fanbattr_speed
    ///
    /// - Start bit: 24
    /// - Signal size: 7 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn fanbattr_speed_raw(&self) -> f32 {
    ...
    /// Set value of fanbattr_speed
    #[inline(always)]
    pub fn set_fanbattr_speed(&mut self, value: f32) -> Result<(), CanError> {
        #[cfg(feature = "range_checked")]
        if value < -1_f32 || 100_f32 < value {
            return Err(CanError::ParameterOutOfRange { message_id: 304 });
        }
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn fanrad_enable(&self) -> bool {
        self.fanrad_enable_raw()
    }
    
    /// Get raw value of fanrad_enable
    ///
    /// - Start bit: 32
    /// - Signal size: 1 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn fanrad_enable_raw(&self) -> bool {
        let signal = self.raw.view_bits::<Lsb0>()[32..33].load_le::<u8>();
        
        signal == 1
    }
    
    /// Set value of fanrad_enable
    #[inline(always)]
    pub fn set_fanrad_enable(&mut self, value: bool) -> Result<(), CanError> {
        let value = value as u8;
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn fanradl_speed(&self) -> f32 {
        self.fanradl_speed_raw()
    }
    
    /// Get raw value of fanradl_speed
    ///
    /// - Start bit: 33
    /// - Signal size: 7 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn fanradl_speed_raw(&self) -> f32 {
    ...
    /// Set value of fanradl_speed
    #[inline(always)]
    pub fn set_fanradl_speed(&mut self, value: f32) -> Result<(), CanError> {
        #[cfg(feature = "range_checked")]
        if value < -1_f32 || 100_f32 < value {
            return Err(CanError::ParameterOutOfRange { message_id: 304 });
        }
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn fanradr_speed(&self) -> f32 {
        self.fanradr_speed_raw()
    }
    
    /// Get raw value of fanradr_speed
    ///
    /// - Start bit: 40
    /// - Signal size: 7 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn fanradr_speed_raw(&self) -> f32 {
        let signal = self.raw.view_bits::<Lsb0>()[40..47].load_le::<u8>();
    ...
    /// Set value of fanradr_speed
    #[inline(always)]
    pub fn set_fanradr_speed(&mut self, value: f32) -> Result<(), CanError> {
        #[cfg(feature = "range_checked")]
        if value < -1_f32 || 100_f32 < value {
            return Err(CanError::ParameterOutOfRange { message_id: 304 });
        }
        ...
        self.raw.view_bits_mut::<Lsb0>()[40..47].store_le(value);
        Ok(())
    }
...
impl core::fmt::Debug for Pcu {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        if f.alternate() {
            f.debug_struct("Pcu")
                .field("pump_enable", &self.pump_enable())
                .field("pumpl_speed", &self.pumpl_speed())
                .field("pumpr_speed", &self.pumpr_speed())
                .field("fanbatt_enable", &self.fanbatt_enable())
                .field("fanbattl_speed", &self.fanbattl_speed())
                .field("fanbattr_speed", &self.fanbattr_speed())
                .field("fanrad_enable", &self.fanrad_enable())
                .field("fanradl_speed", &self.fanradl_speed())
                .field("fanradr_speed", &self.fanradr_speed())
            .finish()
        } else {
...
impl<'a> Arbitrary<'a> for Pcu {
    fn arbitrary(u: &mut Unstructured<'a>) -> Result<Self, arbitrary::Error> {
        let pump_enable = u.int_in_range(0..=1)? == 1;
        let pumpl_speed = u.float_in_range(-1_f32..=100_f32)?;
        let pumpr_speed = u.float_in_range(-1_f32..=100_f32)?;
        let fanbatt_enable = u.int_in_range(0..=1)? == 1;
        let fanbattl_speed = u.float_in_range(-1_f32..=100_f32)?;
        let fanbattr_speed = u.float_in_range(-1_f32..=100_f32)?;
        let fanrad_enable = u.int_in_range(0..=1)? == 1;
        let fanradl_speed = u.float_in_range(-1_f32..=100_f32)?;
        let fanradr_speed = u.float_in_range(-1_f32..=100_f32)?;
        Pcu::new(pump_enable,pumpl_speed,pumpr_speed,fanbatt_enable,fanbattl_speed,fanbattr_speed,fanrad_enable,fanradl_speed,fanradr_speed).map_err(|_| arbitrary::Error::IncorrectFormat)
    }
}
...
impl PcuRf {
    ...
    /// Construct new PcuRf from values
    pub fn new(rf_signal: bool) -> Result<Self, CanError> {
        let mut res = Self { raw: [0u8; 1] };
        res.set_rf_signal(rf_signal)?;
        Ok(res)
    }
    ...
    /// - Receivers: PCU
    #[inline(always)]
    pub fn rf_signal(&self) -> bool {
        self.rf_signal_raw()
    }
    
    /// Get raw value of rf_signal
    ///
    /// - Start bit: 0
    /// - Signal size: 1 bits
    /// - Factor: 1
    ...
    /// - Value type: Unsigned
    #[inline(always)]
    pub fn rf_signal_raw(&self) -> bool {
        let signal = self.raw.view_bits::<Lsb0>()[0..1].load_le::<u8>();
        
        signal == 1
    }
    
    /// Set value of rf_signal
    #[inline(always)]
    pub fn set_rf_signal(&mut self, value: bool) -> Result<(), CanError> {
        let value = value as u8;
        self.raw.view_bits_mut::<Lsb0>()[0..1].store_le(value);
        Ok(())
    }
...
impl core::convert::TryFrom<&[u8]> for PcuRf {
    type Error = CanError;
...
#[cfg(feature = "debug")]
impl core::fmt::Debug for PcuRf {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        if f.alternate() {
            f.debug_struct("PcuRf")
                .field("rf_signal", &self.rf_signal())
            .finish()
        } else {
            f.debug_tuple("PcuRf").field(&self.raw).finish()
        }
    }
}

#[cfg(feature = "arb")]
impl<'a> Arbitrary<'a> for PcuRf {
    fn arbitrary(u: &mut Unstructured<'a>) -> Result<Self, arbitrary::Error> {
        let rf_signal = u.int_in_range(0..=1)? == 1;
        PcuRf::new(rf_signal).map_err(|_| arbitrary::Error::IncorrectFormat)
    }
}
